...
export const CreateAgentModal: React.FC<CreateAgentModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl max-w-5xl w-full mx-4 max-h-[95vh] overflow-hidden border-2 border-black">
        ...
        {showSaveConfirmation && (
          <div className="px-6 py-3 bg-gray-100 border-b border-gray-400">
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button
                      type="button"
                      onClick={addSample}
                      className="flex items-center space-x-2 px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors border-2 border-black"
                    >
                  ...
                  {samples.length === 0 ? (
                    <div className="text-center py-8 bg-gray-100 rounded-lg border border-gray-400">
                      <Upload className="w-12 h-12 text-gray-500 mx-auto mb-4" />
                      <h4 className="text-lg font-medium text-black mb-2">No samples yet</h4>
                      <p className="text-gray-600 mb-4">Add writing samples to train {formData.name || 'this agent'}</p>
                      <button
                        type="button"
                        onClick={addSample}
                    ...
                    <div className="space-y-4">
                      {samples.map((sample, index) => (
                        <div key={sample.id} className="bg-gray-100 rounded-lg p-4 border border-gray-400">
                          <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex justify-between items-center p-6 border-t-2 border-black">
            ...
            <div className="flex space-x-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors border-2 border-black"
              >
